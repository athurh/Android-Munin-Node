...
public class munin_time implements Plugin_API {
	...
	public Void run(Handler handler) {
		...
		output.append("graph_args --base 1000 --logarithmic\n");
		...
		output.append("time.min 0\n");
		output.append("time.draw AREA\n");
		output.append("time.info Time spent running the munin service\n");
		output.append("plugin.label Plugins\n");
		output.append("plugin.min 0\n");
		output.append("plugin.draw AREA\n");
		output.append("plugin.info Time spent running the munin plugins\n");
		output.append("upload.label Upload\n");
		output.append("upload.min 0\n");
		output.append("upload.draw STACK\n");
